	...
	<input type="submit" value="Picture-Response" name="PR" onClick="addQuestion(this)">
	<input type="submit" value="Multi-Answer" name="MA" onClick="addQuestion(this)">
	<input type="submit" value="Multiple Choice-Answers" name="MCA" onClick="addQuestion(this)"><br>
