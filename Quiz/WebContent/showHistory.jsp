...
<a href="index.jsp">Quiz Web Site</a>
		...
		<% } else { %>
			...
			<% UserManager uM = (UserManager) getServletContext().getAttribute("userM");
				...
				ArrayList<History> hst = (ArrayList<History>) request.getAttribute("userhist");
				request.removeAttribute("userhist");
			%>
				<div id="content">
					<br>
					<br> 
					...
					<% for (int i=0; i<hst.size(); i++) { %>
						<% String name = qDao.getNameByQuizId(hst.get(i).getQuiz_id()); %>
						
						<p> <%= (i+1) + ". " + name %> </p> <br>
						<i>  <%= "     Score:  " + hst.get(i).getScore() %></i> <br> <br>
